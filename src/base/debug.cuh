...
template <class T> void print_buffer(int buffer_size, T *d_buffer) {
    T *h_buffer = new T[buffer_size];
    cudaMemcpy(h_buffer, d_buffer, buffer_size * sizeof(T), cudaMemcpyDeviceToHost);
    std::cout << "Buffer " << d_buffer << std::endl;
